...
SELECT pg_catalog.pg_extension_config_dump('public.graphs_templates', '');
SELECT pg_catalog.pg_extension_config_dump('public.graphs_templates_id_seq', '');
...
/*
public.update_current_user
Change the password of an current user.
